                            ...
                            <div class="grid grid-cols-12 gap-6 items-center">
                                ...
                                <div class="col-span-12 md:col-span-8 lg:col-span-9">
                                    ...
                                    <div class="mt-4 flex items-center gap-3">
                                        ...
                                        <button class="ml-2 w-10 h-10 flex items-center justify-center border rounded-lg text-gray-600 hover:bg-red-50 hover:text-red-600 transition">♡</button>
                                    </div>
                                    </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                                ...
                                <?php foreach ($popularProducts as $index => $product): ?>
                                    <div class="bg-white rounded-xl p-4 shadow-card flex flex-col">
                                        ...
                                        <div class="flex-1">
                                            <div class="text-sm font-medium"><?= $product['name'] . " (" . ($index + 1) . ")" ?></div> 
                        ...
                        <div class="sticky top-6 space-y-6">
                            ...
                            <div class="bg-white rounded-2xl p-4 shadow-card">
                                ...
                                <div class="space-y-3 max-h-72 overflow-auto pr-2">
                                    <div class="flex items-center gap-3"><div class="w-12 h-12 img-placeholder rounded-md bg-gray-100"></div><div class="flex-1"><div class="text-sm font-medium">Product 1</div><div class="text-xs text-gray-400">Details</div></div><div class="text-sm text-gray-500">$45.5</div></div>
                                    <div class="flex items-center gap-3"><div class="w-12 h-12 img-placeholder rounded-md bg-gray-100"></div><div class="flex-1"><div class="text-sm font-medium">Product 2</div><div class="text-xs text-gray-400">Details</div></div><div class="text-sm text-gray-500">$45.5</div></div>
                                    <div class="flex items-center gap-3"><div class="w-12 h-12 img-placeholder rounded-md bg-gray-100"></div><div class="flex-1"><div class="text-sm font-medium">Product 3</div><div class="text-xs text-gray-400">Details</div></div><div class="text-sm text-gray-500">$45.5</div></div>
                                    <div class="flex items-center gap-3"><div class="w-12 h-12 img-placeholder rounded-md bg-gray-100"></div><div class="flex-1"><div class="text-sm font-medium">Product 4</div><div class="text-xs text-gray-400">Details</div></div><div class="text-sm text-gray-500">$45.5</div></div>
                                    <div class="flex items-center gap-3"><div class="w-12 h-12 img-placeholder rounded-md bg-gray-100"></div><div class="flex-1"><div class="text-sm font-medium">Product 5</div><div class="text-xs text-gray-400">Details</div></div><div class="text-sm text-gray-500">$45.5</div></div>
                                </div>
                            </div>
                        </div>
                    </aside>
